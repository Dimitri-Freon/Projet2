...
<body>
  ...
  <main>
    <section class="content">
      ...
      <div class="row">
      <div class="container">
      <h5>Détails du membre n°${membre.getId() } </h5> <!-- TODO : remplacer 007 par l'id du membre -->
        <div class="row">
	      <form action="/TP3Ensta/membre_details?id=${membre.getId() }" method="post" class="col s12"> <!-- TODO : remplacer idDuMembre par l'id du membre -->
	        <div class="row">
	          ...
	          <div class="input-field col s4">
	            <input id="prenom" type="text" value="${membre.getPrenom() }" name="prenom"> <!-- TODO : remplacer prenomDuMembre par le prénom du membre -->
	            <label for="prenom">Prénom</label>
	          </div>
	          <div class="input-field col s4">	              <!-- TODO : faire en sorte que l'option correspondant à l'abonnement du membre soit sélectionnée par défaut -->
	            ...
	            <select name="abonnement" class="browser-default">
	              ...
	              <!-- Pour cela, vous devez rajouter l'attribut selecter sur la balise <option> concernée -->
	              <option value="BASIC" ${(membre.getAbonnement == "BASIC") ? " selected" : ""}>Abonnement BASIC</option>
	              <option value="PREMIUM" ${(membre.getAbonnement == "PREMIUM") ? " selected" : ""}>Abonnement PREMIUM</option>
	              <option value="VIP" ${(membre.getAbonnement == "VIP") ? " selected" : ""}>Abonnement VIP</option>
	            </select>
	          </div>
	        </div>
	        <div class="row">
	        ...
	        <div class="row">
	          ...
	          <div class="input-field col s6">
	            <input id="telephone" type="tel" value="${membre.getTelephone() }" name="telephone"> <!-- TODO : remplacer telephoneDuMembre par le téléphone du membre -->
	        ...
	        <table class="striped">
              ...
              <tbody id="results">
                ...
                <c:forEach var="emprunt" items="${emprunts}">
	                <tr>
	                  <td> ${emprunt.getLivre().getTitre() } <br /> <i>${emprunt.getLivre().getAuteur() }</i></td>
