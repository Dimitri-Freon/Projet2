	        ...
	        <div class="col s12">
	          <table class="striped no-padding">
                ...
                <tbody>
                	...
                	<c:forEach items="${Livre_list}" var="item">                
	                    <tr>
	                        <td> ${item.getTitre() } </td>
	                        <td> ${item.getAuteur() }  </td>
	                        <td>  ${item.getIsbn() }  </td>
	                        <td class="center"><a href="livre_details?id=${item.getId() }"><ion-icon class="details" name="information-circle-outline"></ion-icon></a></td>
