	        ...
	        <div class="row">
	          <div class="input-field col s12">
	            <select id="id" name="id" class="browser-default">
	              ...
	              <c:forEach items="${ListCurrentEmprunt}" var="item">   
		              <option value="${item.getId() }"> ${item.getLivre().getTitre() }, emprunté par ${item.getMembre().getNom() } ${item.getMembre().getPrenom() } </option>
		          </c:forEach>
